...
import (
	...
	"github.com/haozi4263/etcd-operator/controllers"
...
var (
	...
	defaultBackupImage = "haozi4263/etcd-operator-backup:v0.0.9"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "d5612d44.shimo.im",
	})
	if err != nil {
	...
	if err = (&controllers.EtcdBackupReconciler{
		...
		Scheme:      mgr.GetScheme(),
		Recorder:    mgr.GetEventRecorderFor("etcdbackup-controller"), // 实例化event
