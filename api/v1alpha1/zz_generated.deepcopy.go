...
func (in *BackupSoucre) DeepCopyInto(out *BackupSoucre) {
	*out = *in
	if in.S3 != nil {
		in, out := &in.S3, &out.S3
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupSoucre.
func (in *BackupSoucre) DeepCopy() *BackupSoucre {
	if in == nil {
		return nil
	}
	out := new(BackupSoucre)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EtcdBackupSpec) DeepCopyInto(out *EtcdBackupSpec) {
	*out = *in
	in.BackupSoucre.DeepCopyInto(&out.BackupSoucre)
}
